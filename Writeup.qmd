...
$$ Then we have the following variational parameter updates using the batch-wise updating algorithm: \$\$ (s\_{j, k}^l)^2 = \frac{\sigma^2}{1/\sigma^2_\beta + \sum_{i=1}^n x_{ik}^2w_l(\mathbf z_i)},
